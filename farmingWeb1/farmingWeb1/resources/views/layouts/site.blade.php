...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> khoaht2412001@gmail.com</li>
                <li>0978269200</li>
            </ul>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                <li><i class="fa fa-envelope"></i> khoaht2412001@gmail.com</li>
                                <li>Vũ La, Nam Đồng, Hải Dương</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="#"><i class="fa fa-heart"></i> <span>1</span></a></li>
                            <li><a href="{{route('view')}}"><i class="fa fa-shopping-bag"></i> <span>{{$cartss->total_quantity}}</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>{{$cartss->total_price}}</span></div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address: Vũ La Nam Đồng Hải Dương</li>
                            <li>Phone: 0978269200 </li>
                            <li>Email: khoaht2412001@gmail.com</li>
                        </ul>
                    </div>
                </div>
